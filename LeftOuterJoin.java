...
public class LeftOuterJoin {
	...
	public static void main(String args[]) throws Exception {
		...
		if(params.has("input1") && params.has("input2") && params.has("output")) {
			...
			DataSet<Tuple3<Integer, String, String>> leftJoined = leftData.leftOuterJoin(rightData).where(2).equalTo(0).with(new JoinFunction<Tuple3<Integer,String,Integer>, Tuple2<Integer,String>, Tuple3<Integer, String, String>>() {
